  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-50 to-white p-6">
      ...
      <div className="max-w-4xl mx-auto mt-10 grid sm:grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-yellow-100 border-l-4 border-yellow-500 p-4 rounded-xl shadow-sm transition-all duration-200 transform hover:scale-105 hover:shadow-lg cursor-pointer hover:bg-yellow-200 hover:bg-opacity-80 focus:outline-none focus:ring-2 focus:ring-yellow-500">
          <h2 className="text-base font-semibold text-gray-800 mb-2">
            Requested for Upload
          </h2>
          <p className="text-xs text-gray-600">
            View and manage question papers requested for upload.
          </p>
        </div>
