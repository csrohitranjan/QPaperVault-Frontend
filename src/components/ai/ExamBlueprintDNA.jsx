      ...
      <div className={`relative z-20 max-w-7xl w-full mx-auto flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8 ${!data && !loading ? "px-4 pt-14 pb-6 sm:p-8 lg:p-10" : ""}`}>
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-indigo-400">Blueprint DNA Engine</span>
          </div>
          ...
          <div className="h-full flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6 py-8 sm:py-10 md:-mt-8">
            <div className="relative mb-6 sm:mb-8">
              ...
              <div className="relative w-28 h-28 sm:w-32 sm:h-32 bg-[#0f111a] rounded-[2.25rem] sm:rounded-[3rem] flex items-center justify-center border border-white/10 shadow-3xl group transition-transform duration-700 hover:scale-110">
                 <Fingerprint size={48} className="text-zinc-800 group-hover:text-indigo-400 transition-colors duration-700 sm:w-14 sm:h-14" strokeWidth={0.5} />
              </div>
            </div>
            <div className="space-y-3">
              <h3 className="text-2xl sm:text-3xl font-black text-white tracking-[0.12em] sm:tracking-widest uppercase">Blueprint Dormant</h3>
        ...
        {loading && (
          <div className="h-full flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6 py-8 sm:py-10">
            <div className="relative mb-8 sm:mb-10">
              ...
              <Dna size={64} className="text-indigo-500/40 animate-pulse sm:w-20 sm:h-20" strokeWidth={0.5} />
            </div>
            <div className="space-y-2">
              <h3 className="text-lg sm:text-xl font-black text-white tracking-[0.12em] sm:tracking-widest uppercase animate-pulse">Mapping DNA...</h3>
              <p className="text-zinc-500 text-[9px] font-bold uppercase tracking-[0.2em] sm:tracking-[0.5em]">Deconstructing Historical Topic Matrix</p>
            </div>
          </div>
        )}
